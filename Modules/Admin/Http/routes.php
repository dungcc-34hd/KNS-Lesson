...
// ajax
    ...
    Route::group(['prefix' => 'manager-lesson'], function () {
        ...
        Route::get('/check-lesson-name/{}', 'ManagerLessonController@checkLessonName')->name('admin.managerLesson.checkLessonName');
        ...
        Route::get('/check-lesson-detail-name', 'ManagerLessonController@checkLessonDetailName')->name('admin.managerLesson.checkLessonDetailName');
