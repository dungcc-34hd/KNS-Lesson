...
@section('content')
    ...
    <div class="content-wrapper" id="app">
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    <a href="{{route('admin.provincial.create')}}" class="btn btn-primary">Create</a>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                ...
                <section class="col-lg-12 connectedSortable">
                    ...
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">Provincial Lists</h3>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm">
                                                    <a class="btn btn-success"
                                                       href="{{route('admin.provincial.show',['id' => $provincial->id])}}"
                                                       title="Detail">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                    <a class="btn btn-info"
                                                       href="{{route('admin.provincial.edit',['id' => $provincial->id])}}"
                                                       title="Edit">
