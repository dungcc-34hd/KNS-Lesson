...
@section('content')
    <div class="content-wrapper" id="app">
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    <a href="{{route('admin.typeLesson.create')}}" class="btn btn-primary">Tạo dạng nội dung</a>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                ...
                <section class="col-lg-12 connectedSortable">
                    ...
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">Danh sách dạng nội dung</h3>
    ...
    <input type="hidden" id="url-ajax" value="/admin/type-lesson/pagination/">
@endsection
