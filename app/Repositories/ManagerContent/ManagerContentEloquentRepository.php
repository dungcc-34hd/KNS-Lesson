...
namespace App\Repositories\ManagerContent;

use App\Models\GradeLevel;
use App\Repositories\EloquentRepository;

class ManagerContentEloquentRepository extends EloquentRepository implements ManagerContentRepositoryInterface
{
